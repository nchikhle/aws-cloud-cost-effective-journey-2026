# Day 02 Cleanup Checklist - Billing, Credits, and Budget Alerts

## Goal

Confirm that no unnecessary AWS resources were created during Day 2 billing and budget setup.
...
| --------------- |--------------| ----------- |-----------------|
| AWS Account     | Yes on Day 1 | £0 / $0     | Keep            |
| Root MFA        | Yes on Day 1 | £0 / $0     | Keep            |
| AWS Budget      | Yes          | £0 / $0     | Keep            |
| Budget Alerts   | Yes          | £0 / $0     | Keep            |
...
* [x] Record Day 2 estimated cost in Monthly Cost Tracker
...
Estimated cost for Day 2: **£0 / $0**

Reason:

Only billing, credits, and budget alert setup were performed.
...
| Item                       | Status     |
| -------------------------- | ---------- |
| Day 2 billing safety setup | Completed  |
